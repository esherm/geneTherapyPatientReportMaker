...
## Population Size over time points
...
df.tab <- data.frame(
	...
	pngfile=file.path("figureByPatient", sprintf("wordlelist-%i.png", seq(df.wordlist))),
...
if(length(dups)>0) {
  df.kable[tail(which(df.kable==dups),1)] <- ""
}
