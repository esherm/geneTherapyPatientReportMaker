...
In the barplots below, the top 10 sites from each cell type have been annotated in all samples, while the remaining sites have been binned as low abundance (LowAbund).
...
do.call(
  grid.arrange,
  lapply(barplotAbundsBySample, function(data){
