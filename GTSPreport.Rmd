...
siteColors = structure(gg_color_hue(length(unique(annotatedAbundances$maskedRefGeneName))), names=unique(annotatedAbundances$maskedRefGeneName))
siteColors["LowAbund"] <- "#E0E0E0"

ggplot(data=annotatedAbundances, aes(Timepoint, estAbundProp, fill=maskedRefGeneName)) +
