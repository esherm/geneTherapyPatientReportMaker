...
coefficients](https://en.wikipedia.org/wiki/Gini_coefficient) and [Shannon
index](https://en.wikipedia.org/wiki/Diversity_index#Shannon_index). The Gini
...
accounts for both abundance and evenness of the integration events.
