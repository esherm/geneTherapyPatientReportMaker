...
```{r totalBarPlots, fig.height=ifelse(n_cell_types == 1, 4, 2*n_cell_types), fig.width=12}
...
```{r sitetype_heatmap, fig.width=12, fig.height=10*(1+as.integer((n_cell_types-0.1)/6))}
