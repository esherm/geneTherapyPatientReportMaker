...
```{r totalBarPlots, fig.height=(2*n_cell_types), fig.width=12}
...
```{r sampleBarPlots, fig.height=6*(1+as.integer(n_cell_types/3)), fig.width=12}
...
grid.arrange(
  ...
  ncol = 3,
  nrow = 1+as.integer(n_cell_types/3)
)
```
***
<P style="page-break-before: always">
...
```{r sitetype_heatmap, fig.width=12, fig.height=10*(1+as.integer(n_cell_types/6))}
